        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">Retai Sales</li>
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-400 w-5px h-2px"></span>
                    </li>
                    <li class="breadcrumb-item text-muted">Sales Details</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="d-flex flex-column gap-7 gap-lg-10">
                <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-lg-n2 me-auto">
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_ecommerce_sales_order_history">Payment History</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4 " data-bs-toggle="tab" href="#kt_ecommerce_sales_order_summary">Order Summary</a>
                        </li>
                    </ul>
                    <a href="<?= base_url('retail_sales/edit_sale/' . $sales['id']) ?>" class="btn btn-success btn-sm me-lg-n7">Edit Order</a>
                    <a href="<?= base_url('retail_sales') ?>" class="btn btn-primary btn-sm">Add New Order</a>
                </div>
                <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                                ...
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    <tbody class="fw-semibold text-gray-600">
                                        <tr>
                                            <td class="text-muted">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--end::Svg Icon-->Date Time
                                                </div>
                                            </td>
                                            <td class="fw-bold text-end"><?= date('M d, Y h:i A', strtotime($sales['date_time'])) ?></td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bold text-end"><?= $sales['payment_status'] ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bold text-end">
                                                <div class="d-flex align-items-center justify-content-end">
                                                    <a href="javascript:;" class="text-gray-600 text-hover-primary"><?= ucwords($sales['name']) ?></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="fw-bold text-end">
                                                <a href="javascript:;" class="text-gray-600 text-hover-primary"><?= $sales['email'] ?></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">
                                            ...
                                            <td class="fw-bold text-end"><?= $sales['phone'] ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="card card-flush py-4 flex-row-fluid">
                        ...
                        <div class="card-body pt-0 ">
                            <div class="table-responsive" id="payment-info-div">
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    <tbody class="fw-semibold text-gray-600">
                                        <tr>
                                            <td class="text-muted">
                                            ...
                                            <td class="fw-bold text-end">
                                                <a href="javascript:;" class="text-gray-600 text-hover-primary"><?= $formatter->formatCurrency($sales['grand_total'], 'USD') ?></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--end::Svg Icon-->Paid Amount
                                                </div>
                                            </td>
                                            <td class="fw-bold text-end">
                                                <a href="javascript:;" class="text-gray-600 text-hover-primary"><?= $formatter->formatCurrency($paidAmount['amount'], 'USD') ?></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--end::Svg Icon-->Balance
                                                </div>
                                            </td>
                                            <td class="fw-bold text-end">
                                                <a href="javascript:;" class="text-gray-600 text-hover-primary"><?= $formatter->formatCurrency($sales['grand_total'] - $paidAmount['amount'], 'USD') ?></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="card card-flush py-4 flex-row-fluid">
                                <div class="card-header">
                                    <div class="col-md-12 row">
                                        ...
                                        <div class="col">
                                            <button class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#modal" onclick="Payment.addPaymentModal(<?= $sales['id'] ?>)">Add Payment</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body pt-0">
                                    <div class="table-responsive" id="payment-div">
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                            <thead>
                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="min-w-175px">Balance</th>
                                                    <th class="min-w-100px">Note</th>
                                                    <th class="min-w-100px">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody class="fw-semibold text-gray-600">
                                                <?php $balace = $sales['grand_total'] ?>
                                                <?php foreach ($payments as $payment) : ?>
                                                    <?php $balace = $balace - $payment['amount'] ?>
                                                    <tr>
                                                        <td><?= date('M d, Y', strtotime($payment['datetime'])) ?></td>
                                                        <td>
                                                            <div class="badge badge-light-success"><?= $payment['payment_method'] ?></div>
                                                        </td>
                                                        <td><?= $formatter->formatCurrency($payment['amount'], 'USD') ?></td>
                                                        <td><?= $formatter->formatCurrency($balace, 'USD') ?></td>
                                                        <td><?= $payment['payment_note'] ?></td>
                                                        <td>
                                                            <button class="btn btn-icon btn-primary me-2 mb-2" href="javascript:;" data-bs-toggle="modal" data-bs-target="#modal" onclick="Payment.updatePaymentModal(<?= $payment['id'] ?>)">
                                                                <i class="fa fa-edit"></i>
                                                            </button>
                                                            <button class="btn btn-icon btn-danger me-2 mb-2" onclick="Payment.deletePayment(<?= $payment['id'] ?>)">
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10">
                            <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
                                <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                                    ...
                                    <div class="card-body pt-0">
                                        <b>Sales </b> : <?= $sales['sale_note'] ?>
                                        <br>
                                        <b>Staff </b> : <?= $sales['staff_note'] ?>
                                    </div>
                                </div>
                                <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                                    <div class="card-header">
                                ...
                                <div class="card-body pt-0">
                                    <div class="table-responsive">
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                <?php $grandTotal = 0; ?>
                                                <?php foreach ($salesDetails as $salesDetail) : ?>
                                                    <?php $productTotal = (floatval($salesDetail['price']) * floatval($salesDetail['qty'])); ?>
                                                    <?php $grandTotal += $productTotal; ?>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="ms-5">
                                                                    <a href="javascript:;" class="fw-bold text-gray-600 text-hover-primary"><?= ucwords($salesDetail['name']) ?></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="text-end"><?= $salesDetail['qty'] ?></td>
                                                        <td class="text-end"><?= $formatter->formatCurrency($salesDetail['price'], 'USD') ?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-dark fs-3 fw-bolder text-end"><?= $formatter->formatCurrency($sales['grand_total'], 'USD') ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
...
<script>
    const Payment = {
        addPaymentModal: (salesId = 0) => {
            $.ajax({
                url: `${siteURL}payment/add_payment`,
                type: "GET",
                dataType: "HTML",
                data: {
                    'sales_id': salesId,
            ...
            $.ajax({
                ...
                success: (result) => {
                    ...
                    if (result.status == 200) {
                        ...
                        $("#payment-div").load(location.href + " #payment-div");
                        $("#payment-info-div").load(location.href + " #payment-info-div");
                        $("#modal").modal('hide');
                        $("#modal-content").html('');
                    } else {
        ...
        updatePaymentModal: (paymentId = 0) => {
            $.ajax({
                url: `${siteURL}payment/update_payment`,
                type: "GET",
                dataType: "HTML",
                data: {
        ...
        deletePayment: (id = 0) => {
            if (id) {
                Swal.fire({
                    html: `You won't be able to recover this payment and its details`,
                    icon: "info",
                    ...
                    if (data.isConfirmed) {
                        $.ajax({
                            url: `${siteURL}payment/delete_payment`,
                            type: "get",
                            dataType: "json",
                            data: {
                                id: id,
